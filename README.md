...
* Mac installer : [MIDI-monitor-1.0.2.dmg](https://github.com/ossandust/midi-monitor/releases/download/v1.0.2/MIDI-monitor-1.0.2.dmg)
* Windows installer : [MIDI-monitor-Setup-1.0.2.exe](https://github.com/ossandust/midi-monitor/releases/download/v1.0.2/MIDI-monitor-Setup-1.0.2.exe)
